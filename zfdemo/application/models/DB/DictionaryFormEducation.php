...
class DB_DictionaryFormEducation extends Zend_Db_Table {
    protected $_name = 'dictionary_form_education';
    protected $_primary = 'id';
     
    public function getData($bachelor_param) {
        $select = $this->select()
            ->from(array('b' => 'bachelor_course'), array('form_education_id'))
            ->join(array('e' => $this->_name), 'e.id = b.form_education_id', array('name'))
